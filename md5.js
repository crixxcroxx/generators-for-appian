...
document.getElementById("submit").addEventListener("click", (e) => {
  ...
  let hashed = MD5(value + date);

  document.getElementById("result").innerHTML = hashed;
  document.getElementById("first").innerHTML = hashed.slice(0, 10);
  document.getElementById("last").innerHTML = hashed.slice(22, hashed.length);
});
